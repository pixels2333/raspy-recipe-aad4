...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-recipe-aad4
```

A live public deployment of this template is available at [https://raspy-recipe-aad4.templates.workers.dev](https://raspy-recipe-aad4.templates.workers.dev)
